...
obj = (1, 1) #object coorinates, sample(1,1) - upper left corner
...
def fn_angle_head_nose_obj (file, obj):
    ...
    for line in lines[3:]:
        ...
        try:
            ...
            angle_head_nose_obj = (polar_head_nose, polar_head_obj)
            angle_head_nose_obj_table.append(angle_head_nose_obj)
        except ValueError:
            #print("error")
            angle_head_nose_obj_table.append("NaN")
    return angle_head_nose_obj_table

print("done")
#np.savetxt('C:\\Users\\Kacper\\Documents\\ASD_computational_ethology\\KL011_enc-sample\\KL011-encDLC_resnet50_texture_sucroseJun18shuffle1_126000_analysis.csv', 
#           fn_nose_velocity(file_name), delimiter='', fmt="%s")
